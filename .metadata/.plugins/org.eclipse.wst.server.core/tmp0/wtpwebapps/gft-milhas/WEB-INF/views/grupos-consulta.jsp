...
<body>
	...
	<div class="container mt-4">
		...
		<div class="row mb-3">
			<div class="col-md-6">
				<h4>
					<strong>GFT Milhas</strong> Consulta de Grupos
				</h4>
				Pesquise os grupos desejados:
			</div>
		</div>

		<form id="formConsulta" action="consultar-grupos" method="get"
			class="mb-3">

			<div class="row">
				<div class="col-md-3">
					<label>Nome do evento:</label>
					<form:input path="model" id="nome" name="nome" type="text"
						class="form-control" />
				</div>
				...
				<div class="col-md-6">
					...
					<input type="submit" class="btn btn-primary"
						value="Pesquisar Grupos" /> <a
						href="/gft-milhas/grupos-cadastro" class="btn btn-success">
						Cadastrar Grupo </a>
				</div>
			</div>
		...
		<c:if test="${grupos.size() > 0}">
			...
			<table id="tabela-grupos" class="table table-hover table-striped">
				...
				<tbody>
					...
					<c:forEach items="${grupos}" var="t">
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><a href="/gft-milhas/grupos-edicao?id=${t.idGrupo}"
								class="btn btn-primary btn-sm"> Editar </a> <a
								href="/gft-milhas/grupos-exclusao?id=${t.idEvento}"
								onclick="return confirm('Deseja realmente excluir o grupo: ${t.nome}?');"
				...
				<tfoot>
					<tr>
						<td colspan="6">Quantidade de grupos: <strong>${grupos.size()}</strong>
						</td>
					</tr>
				</tfoot>
			</table>
